							...
							while($_g1 < $_g2) {
								...
								if($i === $last) {
									...
									if($tmp9) {
										...
										$this->buf->add($v4);
										unset($v4,$tmp10,$l1,$c2);
									}
									unset($tmp9,$tmp8);
								}
								unset($tmp7,$tmp5,$tmp4,$i);
							}
						}
						$this->buf->b .= "]";
					} else {
						if((is_object($_t3 = $c) && ($_t3 instanceof Enum) ? $_t3 == _hx_qtype("haxe.ds.StringMap") : _hx_equal($_t3, _hx_qtype("haxe.ds.StringMap")))) {
							...
							$o = _hx_anonymous(array());
							{
								...
								while(true) {
									...
									$value = $v5->get($k1);
									$o->{$k1} = $value;
									unset($value,$tmp12,$k1);
								}
							}
							$tmp13 = Reflect::fields($o);
							$this->fieldsString($o, $tmp13);
						} else {
							if((is_object($_t4 = $c) && ($_t4 instanceof Enum) ? $_t4 == _hx_qtype("Date") : _hx_equal($_t4, _hx_qtype("Date")))) {
								...
								$tmp15 = Reflect::fields($v);
								$this->fieldsString($v, $tmp15);
							}
						}
					}
				}
